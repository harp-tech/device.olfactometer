...
namespace Harp.Olfactometer
{
    ...
    /// <summary>
    /// Represents an operator that writes the sequence of <see cref="Olfactometer"/>" messages
    /// to the standard Harp storage format.
    /// </summary>
    [Description("Writes the sequence of Olfactometer messages to the standard Harp storage format.")]
    public partial class DeviceDataWriter : Sink<HarpMessage>, INamedElement
    {
        ...
        string INamedElement.Name => nameof(Olfactometer) + "DataWriter";
        ...
        public string Path
        {
            ...
            set => writer.FileName = System.IO.Path.Combine(value, nameof(Olfactometer) + BinaryExtension);
        }
